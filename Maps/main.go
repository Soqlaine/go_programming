...
func main() {
	...
	fmt.Println(balances) // => map[CHF:600 EUR:555.11 GBP:800.6 USD:500.5]
	...
	if ok {
		...
		fmt.Println("The RON value is not exists in the map!")
	}
	...
	friends := map[string]int{"Dan": 40, "Marry": 35}
	...
	fmt.Println("neighbour: ", neighbour) // -> map[Dan:30 Maria:35]
	...
	fmt.Println("Colleagues: ", colleagues)
}
